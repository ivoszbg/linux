...
static const struct samsung_pin_bank_data exynos8895_pin_banks0[] __initconst = {
	...
	EXYNOS850_PIN_BANK_EINTW(7, 0x0A0, "gpa4", 0x24),
};
...
static const struct samsung_pin_bank_data exynos8895_pin_banks1[] __initconst = {
	...
	EXYNOS850_PIN_BANK_EINTG(7, 0x020, "gph1", 0x04),
	EXYNOS850_PIN_BANK_EINTG(4, 0x040, "gph3", 0x08),
};

/* pin banks of exynos8895 pin-controller 2 (VTS) */
static const struct samsung_pin_bank_data exynos8895_pin_banks2[] __initconst = {
	EXYNOS850_PIN_BANK_EINTG(3, 0x000, "gph2", 0x00),
};
...
static const struct samsung_pin_bank_data exynos8895_pin_banks3[] __initconst = {
	EXYNOS850_PIN_BANK_EINTG(3, 0x000, "gpi0", 0x00),
	EXYNOS850_PIN_BANK_EINTG(8, 0x020, "gpi1", 0x04),
};
...
static const struct samsung_pin_bank_data exynos8895_pin_banks4[] __initconst = {
	EXYNOS850_PIN_BANK_EINTG(8, 0x000, "gpj1", 0x00),
	EXYNOS850_PIN_BANK_EINTG(7, 0x020, "gpj0", 0x04),
};

/* pin banks of exynos8895 pin-controller 5 (BUSC) */
static const struct samsung_pin_bank_data exynos8895_pin_banks5[] __initconst = {
	EXYNOS850_PIN_BANK_EINTG(2, 0x000, "gpb2", 0x00),
};
...
static const struct samsung_pin_bank_data exynos8895_pin_banks6[] __initconst = {
	EXYNOS850_PIN_BANK_EINTG(8, 0x000, "gpd0", 0x00),
	EXYNOS850_PIN_BANK_EINTG(8, 0x020, "gpd1", 0x04),
	EXYNOS850_PIN_BANK_EINTG(4, 0x040, "gpd2", 0x08),
	EXYNOS850_PIN_BANK_EINTG(5, 0x060, "gpd3", 0x0C),
	EXYNOS850_PIN_BANK_EINTG(4, 0x080, "gpb1", 0x10),
	EXYNOS850_PIN_BANK_EINTG(8, 0x0A0, "gpe7", 0x14),
	EXYNOS850_PIN_BANK_EINTG(8, 0x0C0, "gpf1", 0x18),
};
...
static const struct samsung_pin_bank_data exynos8895_pin_banks7[] __initconst = {
	EXYNOS850_PIN_BANK_EINTG(3, 0x000, "gpb0", 0x00),
	EXYNOS850_PIN_BANK_EINTG(5, 0x020, "gpc0", 0x04),
	EXYNOS850_PIN_BANK_EINTG(5, 0x040, "gpc1", 0x08),
	EXYNOS850_PIN_BANK_EINTG(8, 0x060, "gpc2", 0x0C),
	EXYNOS850_PIN_BANK_EINTG(8, 0x080, "gpc3", 0x10),
	EXYNOS850_PIN_BANK_EINTG(4, 0x0A0, "gpk0", 0x14),
	EXYNOS850_PIN_BANK_EINTG(8, 0x0C0, "gpe5", 0x18),
	EXYNOS850_PIN_BANK_EINTG(8, 0x0e0, "gpe6", 0x1C),
	EXYNOS850_PIN_BANK_EINTG(8, 0x100, "gpe2", 0x20),
	EXYNOS850_PIN_BANK_EINTG(8, 0x120, "gpe3", 0x24),
	EXYNOS850_PIN_BANK_EINTG(8, 0x140, "gpe4", 0x28),
	EXYNOS850_PIN_BANK_EINTG(4, 0x160, "gpf0", 0x2C),
	EXYNOS850_PIN_BANK_EINTG(8, 0x180, "gpe1", 0x30),
	EXYNOS850_PIN_BANK_EINTG(2, 0x1A0, "gpg0", 0x34),
};
